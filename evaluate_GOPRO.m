...
for idx_set = 1:num_set
    file_path = strcat('/media/vipl2/DATA_1/QTh/July_Model/MSSA_MCSA_Gated/results/MSSA_MCSA_Gated/model_400/GoPro/');
    gt_path = strcat('/media/vipl2/DATA_1/QTh/datasets/GoPro/test/target/')
